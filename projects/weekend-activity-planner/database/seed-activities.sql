...
('Tilden Steam Trains', 'Rideable miniature steam train through the redwoods at Tilden Park.', 'trains', 'Grizzly Peak Blvd & Lomas Cantadas', 'Berkeley', '94708', 37.9006, -122.2445, 25, 1, 12, 'outdoor', true, false, true, '{"weekend": {"open": "11:00", "close": "17:00"}}', '$', 4, true, 'Free parking', true, true, false, 'low', 'clean', ARRAY['trains', 'nature', 'outdoor'], 'https://www.ebparks.org/activities/attractions/tilden_train', 'Great for train enthusiasts! $4/person for 12-minute ride. Combine with Tilden Park activities.'),

('Tilden Little Farm', 'Free farm with animals (cows, pigs, chickens, goats) that kids can see up close.', 'farm', 'Tilden Park, Canon Dr', 'Berkeley', '94708', 37.8963, -122.2455, 25, 1, 10, 'outdoor', true, false, false, '{"daily": {"open": "08:30", "close": "17:00"}}', 'free', 0, true, 'Free parking', true, false, true, 'low', 'some_mess', ARRAY['animals', 'farm', 'free', 'educational'], 'https://www.ebparks.org/activities/attractions/tilden_little_farm', 'Free! Great for animal lovers. Can get muddy.'),
