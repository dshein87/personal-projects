...
-- Existing favorites (mentioned by David)
...
('Montclair Village Playground', 'Neighborhood playground in Montclair Village, very close to home.', 'playground', 'Mountain Blvd & Thornhill Dr', 'Oakland', '94611', 37.8338, -122.2099, 5, 1, 8, 'outdoor', true, false, false, '{"daily": {"open": "sunrise", "close": "sunset"}}', 'free', 0, true, 'Street parking', true, false, true, 'medium', 'clean', ARRAY['playground', 'neighborhood'], NULL, 'Walking distance from home!'),
...
('Montclair Farmers Market', 'Sunday farmers market in Montclair Village (very close to home!)', 'farmers_market', 'Moraga Ave', 'Oakland', '94611', 37.8338, -122.2099, 5, 0, 12, 'outdoor', true, false, false, '{"sun": {"open": "09:00", "close": "13:00"}}', 'free', 0, true, 'Street parking', true, true, true, 'low', 'clean', ARRAY['farmers_market', 'food', 'neighborhood'], NULL, 'Walking distance! Sunday mornings in Montclair Village.'),
