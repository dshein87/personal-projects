...
-- - Sesame/cashew/flax-free options (daughter)
...
-- David's mentioned favorites
('Tacos Oscar', 'Mexican', 'Casual taqueria with excellent tacos. Sunday night favorite with ice cream after at De La Creamery.', '4038 Piedmont Ave', 'Oakland', '94611', 37.8282, -122.2384, 8, true, 'Corn tortillas are naturally gluten-free. Ask about cross-contamination.', true, true, true, 'Generally allergen-friendly. Avoid salsas with seeds. Ask about specific allergens.', true, false, true, '{"daily": {"open": "11:00", "close": "21:00"}}', '$', 12, NULL, NULL, '(510) 985-7336', NULL, 'Sunday night tradition! Kids love this place. De La Creamery ice cream after.'),

('Cholita Linda', 'Mexican', 'Popular Mexican street food with great tacos and agua frescas. Near Heather Farms Park.', '4923 Telegraph Ave', 'Oakland', '94609', 37.8392, -122.2619, 12, true, 'Corn tortillas available. Staff knowledgeable about gluten-free options.', true, true, true, 'Ask about specific allergens in salsas and toppings.', true, false, true, '{"daily": {"open": "11:00", "close": "20:00"}}', '$', 14, 'https://www.yelp.com/biz/cholita-linda-oakland', NULL, '(510) 594-9358', 'https://cholitalinda.com', 'Good for lunch after Heather Farms. Kids really like their food.'),
...
('Burma Superstar', 'Burmese', 'Oakland Burmese restaurant with gluten-free options.', '4721 Telegraph Ave', 'Oakland', '94609', 37.8360, -122.2613, 12, true, 'Many rice-based dishes. Will accommodate GF requests. Popular, expect wait.', true, false, true, 'WATCH: Cashews and sesame seeds common in Burmese cuisine. Inform server of all allergies.', true, false, true, '{"daily": {"open": "11:30", "close": "21:00"}}', '$$', 18, 'https://www.yelp.com/biz/burma-superstar-oakland', NULL, '(510) 655-2828', 'https://burmasuperstar.com', 'IMPORTANT: Notify about daughter allergens. Can be very crowded.'),
...
BEGIN
    ...
    RAISE NOTICE 'Wife: Celiac (gluten-free required)';
    RAISE NOTICE 'Daughter: Sesame, Cashew, Flax';
    RAISE NOTICE '===========================================';
    RAISE NOTICE '';
    RAISE NOTICE 'WARNING: Indian and Burmese cuisines often';
    RAISE NOTICE 'contain cashews and sesame. Always notify';
    RAISE NOTICE 'servers about daughter allergen requirements!';
    RAISE NOTICE '===========================================';
END $$;
